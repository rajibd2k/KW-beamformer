...
% 
% % eliminate central sensor
% r_p = r_p(2:end) ;
% phi_p_m = phi_p_m(2:end) ; 
% 
% clear design ;
% 
...
% 
% save(['CCA_nocentralsensor_varying_beamformer'], 'Delta_b_theta', 'Delta_b_phi', 'D', 'W', 'B', 'theta_range', 'phi_range' ) ;
% 
% exit ;
% 
% return ;
...
loadname = 'CCA_nocentralsensor_varying_beamformer' ;
