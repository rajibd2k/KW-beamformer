% Optimized Positions(Radii) of Rings in Concentric Circular Array (CCA)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for p = 1 : P
    ...
    K_p = M_p / 2 ;
    m = [-K_p + 1 : K_p]' ;
    phi_p_m{p} = m * 2 * pi / M_p ;
    
end
    
save('CCA_design_half', 'r_p', 'phi_p_m') ;
...
save('CCA_design_quarter', 'r_p', 'phi_p_m') ;


% CCA (Nyquist) - one-eighth
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
for p = 1 : P
    ring_radius = r_p(p) ;
    sensors_angles = phi_p_m{p} ;
...
save('CCA_design_one-eighth', 'r_p', 'phi_p_m') ;
